...
public class GameB {		// Open GameB{}
	 ...
	 */
	public GameB(String name, Scanner scan, String intro) {
	this.name = name;
	this.scan = scan;
	this.intro = intro;
	}
	...
	public void runGame() {	// Open runGame()
		...
		boolean start = false;	// Whether this is a new GameB or not
